...
namespace Tutorials.Tutorial1
{
    ...
    public class SupervisedActor : UntypedActor
    {
        ...
        protected override void PreRestart(Exception reason, object message) => Console.WriteLine("supervised PreRestart");
        protected override void PostRestart(Exception reason) => Console.WriteLine("supervised PostRestart");
